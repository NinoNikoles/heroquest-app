<x-app-layout>
    <div class="innerWrap">
        <section>
            <div class="grid">
                <p class="breadcrumb col12">
                    <a href="{{ route('dashboard') }}">Dashboard</a> /
                    <span><u>{{ $lobby->name }}</u></span>
                </p>

                <div class="grid justify-between flex-center">
                    <h1 class="marg-bottom-no">
                        Lobby: <span class="text-red-600">{{ $lobby->name }}</span>
                    </h1>

                    <div class="box border border-success rounded bg-01dp">
                        <span >Code:</span>
                        <span class="special">{{ $lobby->code }}</span>
                    </div>
                </div>
            </div>            
        </section>
                ...
                @foreach($lobby->characters as $char)
                    <div class="col3 box border rounded bg-02dp">
                        <div class="grid">
                            ...
                            <div class="w-full">
                                <a href="{{ route('characters.show', $char->id) }}" class="btn-gold w-full rounded t-center">
                                    Charakterbogen
                                </a>
                            </div>
                            @endif
            ...
            <div class="col12 character__dice box rounded border" x-data="{ openDice: true }">
                ...
                <div class="grid" x-show="openDice">
                    <div class="col-6 character__dice__box box border rounded">
                        <h3 class="t-center">Kampf: <span id="base-fight" class="special">{{ $fightDefault }}</span></h3>

                        <div class="character__dice__box__mod">
                            <button onclick="adjustTempDice('fight', -1)" class="btn-minus character__dice__box__mod__btn">-</button>
                            <span id="temp-fight-mod">+0</span>
                            <button onclick="adjustTempDice('fight', 1)" class="btn-plus character__dice__box__mod__btn">+</button>
                        </div>
    ...
    <script>
        ...
        function adjustTempDice(type, change) {
            if(type === 'fight') {
                tempFight += change;
                document.getElementById('temp-fight-mod').innerText = (tempFight >= 0 ? '+' : '') + tempFight;
            } else {
                tempNormal += change;
        ...
        function rollDice(type, amount) {
            ...
            setTimeout(() => {
                ...
                const modValue = (type === 'fight') ? tempFight : tempNormal;
                ...
                tempFight = 0; tempNormal = 0;
                document.getElementById('temp-fight-mod').innerText = "+0";
